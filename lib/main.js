...
Reporting.prototype.uploadBufferToS3Bucket = function(reportKey, buffer) {
       ...
       if (!!this.reporter.options.s3ReportOutputStorage.accessKeyId && !!this.reporter.options.s3ReportOutputStorage.secretAccessKey) {
         ...
         var s3 = new AWS.S3({region: 'us-west-2', accessKeyId: this.reporter.options.s3ReportOutputStorage.accessKeyId, secretAccessKey: this.reporter.options.s3ReportOutputStorage.secretAccessKey})
       } else {
         var s3 = new AWS.S3();
       }
       var params = {
