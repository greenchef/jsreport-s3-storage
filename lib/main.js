...
Reporting.prototype.handleAfterRender = function (request, response) {
  ...
  var renderDateString = renderDate.getFullYear() + "-" + (renderDate.getMonth() + 1) + "-" + renderDate.getDate() + "-" + renderDate.getHours() + "-" + renderDate.getMinutes() + "-" + renderDate.getSeconds()
  var reportKey = request.template.shortid + "/rpt" + renderDateString + ".pdf"
